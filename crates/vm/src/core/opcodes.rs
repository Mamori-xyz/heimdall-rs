...
impl Opcode {
    ...
    pub fn new(code: u8) -> Opcode {
        match code {
            ...
            0x44 => Opcode { code, name: "PREVRANDAO", mingas: 2, inputs: 0, outputs: 1 },
            ...
            0x49 => Opcode { code, name: "BLOBHASH", mingas: 3, inputs: 0, outputs: 1 },
            0x4a => Opcode { code, name: "BLOBBASEFEE", mingas: 2, inputs: 0, outputs: 1 },
